...
import { createImage } from 'Plugins/ImageAPI/ImageExecution'; // 假设 createImage 函数在这个模块中
...
//         if (selectedFile) {
//             try {
//                 const result = await createImage(selectedFile);
//                 console.log(result);
//                 handleClose();
//             } catch (error) {
//                 console.error("Error uploading image:", error);
...
//         <div id="app">
//             <h1>Image Viewer</h1>
//             <img id="image" src="http://localhost:8080/images/0.jpg" alt="Loaded Image" />
//         </div>
//     );
//
//     return (
...
//                 <DialogTitle>上传 JPG, JPEG, PNG 图片</DialogTitle>
//                 <DialogContent>
//                     <input
//                         type="file"
//                         accept=".jpg,.jpeg,.png"
