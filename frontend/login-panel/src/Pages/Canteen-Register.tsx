...
import { PatientRegisterMessage } from 'Plugins/PatientAPI/PatientRegisterMessage'; // 引入 PatientRegisterMessage
import background from '../../images/cwlogin1.jpg';  // 导入背景图片

export function CanteenRegister() {
    ...
    const sendPostRequest = async (message: API) => {
        console.log('Request URL:', message.getURL());
        try {
    ...
    const handleRegister = (event: React.FormEvent) => {
        ...
        const message = new PatientRegisterMessage(username, password); // 使用 PatientRegisterMessage
